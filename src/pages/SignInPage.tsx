...
import { Mail, Lock, Eye, EyeOff, Users, MessageCircle, Rocket } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#FAFAFB] flex items-center justify-center p-4">
      <div className="bg-white max-w-[1200px] w-full min-h-[890px] rounded-[24px] shadow-sm border border-gray-100 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 bg-[#FAFAFC] p-8 lg:p-12 flex flex-col justify-between border-r border-gray-100">
          <div>
            <h1 className="text-3xl font-bold text-[#004AC6] mb-4 font-['Be_Vietnam_Pro']">RySocial</h1>
            ...
            <div className="w-full h-[300px] bg-gradient-to-br from-[#EFF6FF] to-[#DBEAFE] rounded-2xl mb-12 flex items-center justify-center relative overflow-hidden">
              <span className="text-[#004AC6] font-medium">3D Illustration Placeholder</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[15px] font-semibold text-[#1F2937] mb-1">Discover more</h3>
                  <p className="text-[13px] text-[#4B5563]">Explore trending topics and communities you love.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12 xl:p-20 flex flex-col justify-center">
          <div className="max-w-[400px] w-full mx-auto">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#1F2937] mb-2">Sign in to your account</h2>
              <p className="text-[#4B5563]">Welcome back! Please enter your details.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5">
                <label className="block text-[13px] font-semibold text-[#1F2937]">Email or Nickname</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 h-[46px] text-sm rounded-[8px] border-gray-200 focus:ring-1 focus:ring-[#004AC6] focus:border-[#004AC6] placeholder-gray-400 text-gray-900 bg-white"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-10 h-[46px] text-sm rounded-[8px] border-gray-200 focus:ring-1 focus:ring-[#004AC6] focus:border-[#004AC6] placeholder-gray-400 text-gray-900 bg-white"
              ...
              <button
                ...
                disabled={isLoading}
                className={clsx(
                  "w-full flex justify-center py-2 px-4 border border-transparent rounded-[8px] shadow-sm text-sm font-semibold text-white bg-[#004AC6] hover:bg-[#003da3] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#004AC6] h-[42px] items-center transition-colors duration-200",
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button type="button" className="w-full inline-flex justify-center py-2 px-4 border border-gray-200 rounded-[8px] shadow-sm bg-white text-sm font-semibold text-gray-700 hover:bg-gray-50 h-[42px] items-center">
                  Google
                </button>
                <button type="button" className="w-full inline-flex justify-center py-2 px-4 border border-gray-200 rounded-[8px] shadow-sm bg-white text-sm font-semibold text-gray-700 hover:bg-gray-50 h-[42px] items-center">
                  Apple
